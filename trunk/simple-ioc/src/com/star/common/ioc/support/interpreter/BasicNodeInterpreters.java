...
public class BasicNodeInterpreters {
    ...
    public static class IntNodeInterpreter extends AbstractNodeInterpreter {
        protected Object doCreateObject(Node node, String valueString, BeanFactory beanFactory,
                Map<Object, Object> context, String interpreterName) {
    ...
    public static class DateNodeInterpreter extends AbstractNodeInterpreter {
        ...
        protected Object doCreateObject(Node node, String valueString, BeanFactory beanFactory,
                Map<Object, Object> context, String interpreterName) throws ParseException {
    ...
    public static class ClassNodeInterpreter extends AbstractNodeInterpreter {
        ...
        public static Class getClassForName(String valueString, BeanFactory beanFactory) {
            ...
            if (i >= 0) {
                ...
                valueString = prefix + valueString.substring(i + 2, valueString.length());
            }
